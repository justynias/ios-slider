...
@IBDesignable open class RangeSlider: UIControl {
    ...
    ///The color of the bubble abels. `UIColor.clear` by default.
    ...
    public var leftBubbleImage: UIImage? {
        didSet {
            ...
            leftBubbleImageWidth = leftBubbleImage?.size.width ?? 0
            leftBubbleImageHeight = leftBubbleImage?.size.height ?? 0
        }
    }
    public var rightBubbleImage: UIImage? {
        didSet {
            rightBubbleView.image = rightBubbleImage
            rightBubbleImageWidth = rightBubbleImage?.size.width ?? 0
            rightBubbleImageHeight = rightBubbleImage?.size.height ?? 0
        }
    }
    
    public var leftBubbleImageWidth: CGFloat = 0 {
        didSet {
    ...
    public var leftBubbleImageHeight: CGFloat = 0 {
        didSet {
            updateBubbleLabelsPosition()
            updateBubblesPosition()
        }
    ...
    public var rightBubbleImageWidth: CGFloat = 0 {
        didSet {
            updateBubbleLabelsPosition()
            updateBubblesPosition()
        }
    ...
    public var rightBubbleImageHeight: CGFloat = 0 {
        didSet {
            updateBubbleLabelsPosition()
            updateBubblesPosition()
        }
    ...
    let rightBubbleView = UIImageView()
    let leftBubbleView = UIImageView()
    let rightBubbleLabel = UILabel()
    ...
    func updateBubblesPosition() {
        let lowerKnobStartingXPosition = absoultePositionForValue(lowerValue).x
        let upperKnobEndXPosition = absoultePositionForValue(upperValue).x + knobSize
        let rightBubbleViewXPoistion = upperKnobEndXPosition-rightBubbleImageWidth
        let rightBubbleViewYPoistion =  frame.size.height-rightBubbleImageHeight
        
        leftBubbleView.frame = CGRect(x: lowerKnobStartingXPosition, y: 0, width: leftBubbleImageWidth, height: leftBubbleImageHeight)
        
        rightBubbleView.frame = CGRect(x: rightBubbleViewXPoistion, y: rightBubbleViewYPoistion, width: rightBubbleImageWidth, height: rightBubbleImageHeight)
    }
    ...
    func addContentViews(){
        ...
        lowerLabel.alignmentMode = .center
        ...
        upperLabel.alignmentMode = .center
